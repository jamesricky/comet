...
export const LatestBuildsDashboardWidget = ({ tableQuery: { tableData, api, loading, error } }: LatestBuildsDashboardWidgetProps) => {
    ...
    return (
        <DashboardWidgetRoot header={<FormattedMessage id="comet.dashboard.latestBuildsWidget.title" defaultMessage="Latest Builds" />}>
                ...
                {tableData && (
                    <Table<Row>
                        ...
                        columns={[
                            {
                                name: "runtime",
                                header: intl.formatMessage({ id: "comet.dashboard.latestBuildsWidget.runtime", defaultMessage: "Runtime" }),
                                render: (row) => (
                                    <BuildRuntime
                            ...
                            {
                                name: "status",
                                header: intl.formatMessage({ id: "comet.dashboard.latestBuildsWidget.status", defaultMessage: "Status" }),
