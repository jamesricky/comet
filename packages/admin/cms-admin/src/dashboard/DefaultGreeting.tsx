...
export const DefaultGreeting = () => {
    ...
    if (data) {
        return (
            <FormattedMessage id="comet.dashboard.userGreeting" defaultMessage="Hello {givenName}!" values={{ givenName: data.currentUser.name }} />
        );
    }

    return <FormattedMessage id="comet.dashboard.greeting" defaultMessage="Hello!" />;
};
